! subroutine name: prepare_albedo.f90
...
subroutine prepare_albedo(file_in, filename)
    implicit none
    include 'netcdf.inc'
...
!     sure your data are really written to disk.
    ...
    print *,'SUCCESS in writing albedo to ', filename, '!'

    tmp = 'rm '//trim(adjustl(file_in)) !delete the dat file containing the albedo
    call system(tmp)
