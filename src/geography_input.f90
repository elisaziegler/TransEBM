! Read land masks from the preprocess into the EBM main code
      ...
      subroutine geography_input(geography, filename)
      implicit none
      include 'netcdf.inc'

!     This is the name of the data file we will create.
      character*(*) filename
!      parameter (filename = '../input/geography.nc')
      integer ncid
      real error 
...
!     Close the dat file and make sure your data are really written to disk.
      ...
      print *,'SUCCESSFULLY read geography from [', filename,'] into simulation!'
!      write(2,*)'SUCCESSFULLY read geography from [', filename,'] into simulation!'      
      end
